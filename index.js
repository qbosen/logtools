...
const colorfulIndentCss = String.raw`
    /*===========================================================*/
...
const settings = [
  {
    ...
    type: 'boolean',
    default: true,
    title: 'Colorful Indent',
    description: 'Enable colorful indent levels'
  },
];

function main() {
  let styleCss = basicCss;
  if (logseq.settings.colorfulIndent) {
    styleCss += colorfulIndentCss;
  }
